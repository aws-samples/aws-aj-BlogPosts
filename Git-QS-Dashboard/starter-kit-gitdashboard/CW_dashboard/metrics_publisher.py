...
def lambda_handler(event, context):
    ...
    try:
        ...
        summary_metrics = [
            ...
            {'MetricName': 'EstimatedPRClosed', 'Value': summary.get('estimatedPRClosed', 0), 'Unit': 'Count'},
            {'MetricName': 'EstimatedPRPending', 'Value': summary.get('estimatedPRPending', 0), 'Unit': 'Count'},
            {'MetricName': 'ActiveRepositories', 'Value': summary.get('activeRepositories', 0), 'Unit': 'Count'},
            {'MetricName': 'TotalBranches', 'Value': summary.get('totalBranches', 0), 'Unit': 'Count'},
        ]
